...
class MemberPlansScreenProvider extends StatelessWidget {
  final Dio dio;
  const MemberPlansScreenProvider({super.key, required this.dio});
...
class MemberPlansScreen extends StatelessWidget {
  final Dio dio;
  const MemberPlansScreen({super.key, required this.dio});
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          context.read<MyMembershipBloc>().add(LoadMyMembershipEvent());
                        },
                    ...
                    child: Stack(
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            // ONLY FIX: stretch for Arabic so text hugs right edge
