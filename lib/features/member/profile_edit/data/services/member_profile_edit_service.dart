...
// 2. We verify current password first in the Bloc.
// 3. Then we call /api/auth/send-verification.
// 4. User enters OTP.
// 5. We call /api/auth/user/verify-phone-code.
// 6. If OTP is valid, Bloc submits profile update again and saves phone.
// ---------------------------------------------------------------------------
