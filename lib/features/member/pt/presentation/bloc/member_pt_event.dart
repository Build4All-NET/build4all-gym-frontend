...
// Dispatched on screen init — triggers both getFilterOptions and getTrainers in parallel.
class TrainersStarted extends MemberPtEvent {
  const TrainersStarted();
}

// Dispatched when a specialty chip is tapped. null means "All".
class TrainersSpecialtyFilterChanged extends MemberPtEvent {
  final String? specialty;
  const TrainersSpecialtyFilterChanged(this.specialty);
}

// Dispatched when المفضلة chip is tapped — toggles favoritesOnly.
